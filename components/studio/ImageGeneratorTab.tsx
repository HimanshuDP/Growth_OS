...
import { Loader2, Sparkles, Image as ImageIcon, Download, Copy, RefreshCw, Layout, Smartphone } from 'lucide-react';
              ...
              {selectedImg && (
                 <div className="flex flex-col items-center animate-in zoom-in-95 duration-300">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3 justify-center w-full">
                       <button onClick={() => saveToLibraryAndUse(selectedImg)} className="flex-1 min-w-[200px] py-3 bg-brand-orange text-white font-bold rounded-xl hover:bg-brand-orange/80 flex items-center justify-center gap-2">
